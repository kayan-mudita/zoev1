  ...
  return (
    <section id="outcomes" className="relative isolate py-24 sm:py-32">
      ...
      <div className="container">
        <SectionHeading
          eyebrow="Outcomes"
          title="Real operator reps. Predictable lift. You stay in control."
          description="Our operators have solved these exact failure modes across countless diagnostics. Zoe compresses that experience into a system that reliably boosts runway, efficiency, and momentum."
          align="center"
        />
